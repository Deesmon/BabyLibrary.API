...
namespace BabyLibrary.Data.Migrations
{
    public partial class InitializedBooksLoansAndReservation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanStartedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LoanScheduledEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LoanReturnedTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLoan_BookReservation_BookReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLoan_BookReservationId",
                table: "BookLoan",
